...
//                demoViewController?.setNewKeyboardAlhabeticType(ru: ru, uppercased: uppercased)
//            } else {
//                demoViewController?.setNewKeyboardType(keyboardType: type)
//            }
//        case .custom(name: "ru"): demoViewController?.setNewKeyboardAlhabeticType(ru: true)
//        case .custom(name: "en"): demoViewController?.setNewKeyboardAlhabeticType(ru: false)
...
//        demoViewController?.setNewKeyboardAlhabeticType(uppercased: state.isUppercased)
//    }
//}
